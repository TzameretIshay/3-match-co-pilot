        ...
        Create a Match3BoardConfiguration resource ⚙️
            ...
            Sequences
                Sequence rules
                    ...
                    Target pieces
                    Enabled shapes
            Animation flows - Draw cells & pieces animation - Sequence animation - Fall animation - Fill animation - Delay after shuffle
    Match3 Board ⬛
        States
        Signals
        Properties
...
Installation 📦
    ...
    Unpack the ninetailsrabbit.match3_board folder into your /addons folder within the Godot project
